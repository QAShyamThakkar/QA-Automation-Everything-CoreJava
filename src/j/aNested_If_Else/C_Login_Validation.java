...
public class C_Login_Validation {
	...
	// if user name is wrong but password is incorrect ----> You've entered invalid
	// cred
	// if user name is correct but password is correct ----> Login successful
	// if user name is correct but password is incorrect ----> Your password is
	// wrong
